...
SNMPv3, we have defined two fields in a Lua table: name and views. 'name' is the
string, and 'views' is the set of oid views to be allowed to be accessed (e.x.
"." means all nodes registered are available) with read and write permissions.
